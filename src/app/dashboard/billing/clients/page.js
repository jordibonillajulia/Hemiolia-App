                  ...
                  {isAdmin ? (
                    <>
                      <button 
                        ...
                        className="btn btn-glass" 
                        style={{ padding: '0.3rem 0.5rem', marginRight: '0.35rem', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', color: 'var(--color-accent)' }}
                        title="Editar client"
                      >
